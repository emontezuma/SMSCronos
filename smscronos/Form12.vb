...
Public Class Form12
    ...
    Sub RecuperarDatos()
        ...
        Try
            ...
            Dim CadSQL As String = "select id, area, melodia from z_mensajes_melodias order by area"
            ...
            GridView1.Columns(2).Caption = "Archivo con la melodía"
            GridView1.Columns(0).Width = GridControl1.Width * 0.1
            GridView1.Columns(1).Width = GridControl1.Width * 0.3
            GridView1.Columns(2).Width = GridControl1.Width * 0.6
    ...
    Sub BuscarMensaje()
        Me.Cursor = Cursors.WaitCursor
        Try
            Dim CadSQL As String = "select * from z_mensajes_melodias where id = " & Val(MiSecuencia)
            Dim Comando As OdbcCommand = New OdbcCommand(CadSQL)
            Comando.Connection = MiConexion
            Comando.CommandType = CommandType.Text
            Dim Registros As OdbcDataReader = Comando.ExecuteReader
            If Registros.HasRows Then
                ...
                TextEdit18.Text = Strings.Replace(Registros!melodia, "/", "\")
            End If
    ...
    Private Sub SimpleButton3_Click(sender As Object, e As EventArgs) Handles SimpleButton3.Click
        ...
        args.Caption = "Cronos::. Configuración de SMS/Email para MMCall"
        args.Text = "Al eliminar esta melodía ya se reproducirá al momento de generar el mensaje por voz." & Environment.NewLine & "¿Desea continuar y eliminar a traducción?"
        ...
        Try
            Dim CadSQL As String = "delete from z_mensajes_melodias where id = " & Val(LabelControl1.Text)
            Dim Comando As OdbcCommand = New OdbcCommand(CadSQL)
    ...
    Private Sub SimpleButton1_Click(sender As Object, e As EventArgs) Handles SimpleButton1.Click
        ...
        If TextEdit18.Text.Trim.Length = 0 Then
            args.Text = "Especifique el archivo que contiene la melodía prefijo"
        ...
        Try
            CadSQL = "select id from z_mensajes_melodias where id = '" & LabelControl1.Text & "'"
            Comando = New OdbcCommand(CadSQL)
            Comando.CommandText = CadSQL
            Comando.Connection = MiConexion
            Comando.CommandType = CommandType.Text
            ...
            If Registros.HasRows Then
                ...
                CadSQL = "update z_mensajes_melodias set area = '" & TextEdit3.Text & "', melodia = '" & Strings.Replace(TextEdit18.EditValue, "\", "/") & "' where id = " & Val(LabelControl1.Text)
            Else
                CadSQL = "insert into z_mensajes_melodias (area, melodia) values('" & TextEdit3.Text & "', '" & Strings.Replace(TextEdit18.EditValue, "\", "/") & "')"
            End If
            Comando = New OdbcCommand(CadSQL)
            Comando.CommandText = CadSQL
            Comando.Connection = MiConexion
    ...
    Private Sub SimpleButton10_Click(sender As Object, e As EventArgs) Handles SimpleButton10.Click
        ...
        OpenFileDialog1.Filter = "Archivos de audio (*.wav)|*.wav"
        OpenFileDialog1.ShowDialog()
        TextEdit18.Text = OpenFileDialog1.FileName
        TextEdit18.Focus()
        CambiarBotones(1)
    End Sub
