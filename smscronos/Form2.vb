...
Public Class Form2
    ...
    Private Sub SimpleButton3_Click(sender As Object, e As EventArgs) Handles SimpleButton3.Click
        ...
        args.Caption = "Cronos::. Configuración de SMS/Email para MMCall"
        args.Text = "Al eliminar esta carpeta ya se considerará al momento de generar el mensaje por voz." & Environment.NewLine & "¿Desea continuar y eliminar a traducción?"
