...
Public Class Form10
    ...
    Sub RecuperarDatos()
        ...
        Try
            ...
            Dim CadSQL As String = "SELECT staffs.NAME FROM staffs "
            ...
            GridView1.Columns(0).Caption = "Staff/Name"
    ...
    Private Sub GridView1_FocusedRowChanged(sender As Object, e As FocusedRowChangedEventArgs) Handles GridView1.FocusedRowChanged
        MMCRecas = GridView1.GetRowCellValue(e.FocusedRowHandle, GridView1.Columns(0))
    End Sub
End Class